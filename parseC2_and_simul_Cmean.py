#!/usr/bin/python
#########################################
# File Name: parseC2_and_simul_Cmean.py
#
# Purpose: Gene-based C2_mean analyses- Simulate C2_mean gene values to obtain the null distribution
#
# Usage: ./parseC2_and_simul_Cmean.py infile1 infile2
#infile1: SNP-based C2 values; infile2: C2mean_values per gene
#
